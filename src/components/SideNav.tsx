...
import { ArrowUturnLeftIcon, BuildingStorefrontIcon, ChartPieIcon, ChevronDoubleLeftIcon, ChevronDoubleRightIcon, Square3Stack3DIcon, Squares2X2Icon } from '@heroicons/react/24/solid';
...
function SideNav({ }: Props) {
    ...
    return (
        <div className={`z-40 transition-transform duration-500 ${isSidebarOpen ? '-translate-x-0 relative' : '-translate-x-full absolute'} `}>
            <div
                onClick={toggleSidebar}
                className="absolute top-52  -right-12 h-24 w-12 flex justify-center  items-center bg-indigo-500 text-white ps-3 pe-1 rounded-e-3xl hover:bg-indigo-600 shadow-lg "
            // Adjust margin based on sidebar state
            >
                {isSidebarOpen ? (<ChevronDoubleLeftIcon className="w-10 h-10"/>) :
            ...
            <aside
                ...
                className={`rounded-e-lg transition-transform duration-300 delay-75 w-28 h-screen bg-gradient-to-b  from-indigo-500 from-10% via-sky-500 via-60% to-emerald-500 to-90% text-white flex flex-col justify-between shadow-lg 
                ...
                <div className="flex flex-col justify-between h-full px-3 py-6 space-y-6">
                    ...
                    <div className=" justify-center items-center hidden lg:flex">
                        <button className="relative  flex flex-col justify-center items-center p-2 text-gray-200 hover:bg-blue-700 rounded-lg transition-all duration-200">
                            ...
                            <span className="mt-2 text-4xl ">Logo</span>
                    ...
                    <div>
                        <button
                            ...
                            className="flex flex-col justify-center items-center p-2 mb-3 w-full bg-blue-500/50 hover:bg-blue-600 rounded-lg transition-all duration-200"
                        >
                        ...
                        <button
                            ...
                            className="flex flex-col justify-center items-center p-2 w-full bg-red-400/80 hover:bg-red-500 rounded-lg transition-all duration-200"
                        >
