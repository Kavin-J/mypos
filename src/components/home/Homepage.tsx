...
import { allMenu, allCategories, openFullscreen, closeFullscreen } from '../../utils';
...
function Homepage({ }: Props) {
    ...
    return (
        <div className="mx-auto w-full h-full bg-defalt overflow-hidden   pb-2">
            {JSON.stringify(user)}

            <div aria-description='contain' className="flex lg:flex-row flex-col shadow-lg h-full overflow-scroll lg:overflow-hidden  rounded-lg">
                {/* left section */}
                <div aria-description='leftside' className="w-full flex flex-col lg:w-9/12 min-h-screen p-2 overflow-y-hidden ">
                    ...
                    <div className="justify-between flex items-center p-2 ">
                        ...
                        <div className="flex flex-row justify-between items-center p-2 rounded-md ">

                            {/* <div className="text-gray-800 me-2">

                            </div> */}
                            <div className="px-5 py-4 text-nowrap font-bold text-xl text-gray-800 bg-white me-2 rounded-full ">
                                Jest's Cafe
                            </div>
                            ...
                            <div className="relative max-w-md me-5">
                                ...
                                <span className='bg-white border rounded-full max-w-lg border-white text-md font-bold text-gray-800 focus:ring-blue-500 focus:border-blue-500 block w-full ps-16 px-5 py-4 text-nowrap'>
                        ...
                        <div className="relative max-w-md ">
                            ...
                            <div className="absolute bg-defalt m-2 rounded-full inset-y-0 end-0 flex items-center p-2 pointer-events-none">
                                <svg xmlns="http://www.w3.org/2000/svg" height="32px"
                                    className='text-red-400 '
                                    viewBox="0 -960 960 960" width="32px" fill="currentColor"><path d="M480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-84 31.5-156.5T197-763l56 56q-44 44-68.5 102T160-480q0 134 93 227t227 93q134 0 227-93t93-227q0-67-24.5-125T707-707l56-56q54 54 85.5 126.5T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm-40-360v-440h80v440h-80Z" /></svg>
                            </div>
                            <span className='bg-white border rounded-full max-w-lg border-white text-md font-bold text-red-400 focus:ring-blue-500 focus:border-blue-500 block w-full pe-16 px-5 py-4 text-nowrap'>
                                &bull; Close Order</span>
                        </div>
                        {/* <div className="flex flex-row justify-between items-center p-2 rounded-md ">
                            <div className="px-5 py-4 text-nowrap font-bold text-xl text-red-500 bg-white flex me-2 rounded-full ">
                                <span>&bull; Close Order</span>  
                            </div>
                        </div> */}
                    </div>
                    ...
                    <div className='w-full bg-red-50 h-full'>
                ...
                {/* right section */}
                <div aria-description='rightside' className="w-full lg:w-3/12 flex flex-col h-screen p-5">
                    {/* header */}
